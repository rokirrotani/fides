    ...
    <>
      ...
      <main style={{ marginTop: '56px', minHeight: 'calc(100vh - 56px)', background: '#f8fafc' }}>
        ...
        <section className="hero fade-in" style={{
          backgroundImage: 'linear-gradient(135deg, rgba(15, 23, 42, 0.4), rgba(30, 41, 59, 0.6)), url(https://images.unsplash.com/photo-1549333728-0aa0eebf53c7?w=1600&q=80)',
          ...
          <div className="scale-in" style={{ position: 'relative', zIndex: 2 }}>
            ...
            <p style={{ 
              ...
              Immobili di Pregio nel Cuore del Capoluogo Piemontese
            </p>
            ...
            <div style={{
              ...
              onMouseLeave={(e) => {
                ...
                <p style={{
                  ...
                  Immobili nelle zone più ambite di Torino, vicino ai principali servizi e attrazioni della città.
                </p>
              </div>
              ...
              onMouseLeave={(e) => {
                ...
                <p style={{
                  ...
                  Il mercato torinese offre opportunità di crescita e rendite stabili per chi investe nel settore immobiliare.
                </p>
              </div>
              ...
              onMouseLeave={(e) => {
                ...
                <p style={{
                  ...
                  I nostri esperti conoscono il mercato torinese e ti aiutano a trovare l'immobile più adatto alle tue esigenze.
                </p>
              </div>
          ...
          <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
            ...
            {!loading && (
              <>
                ...
                {/* Properties Grid */}
                {properties.length > 0 && (
                  <PropertiesGrid branch="torino" properties={properties} />
                )}
